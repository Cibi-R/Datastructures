...
#define QUEUE_DYNAMICt_H           "trash/queue/api/queue_dynamic_t.h"

#define SINGLE_LIST_STATICt_H      "trash/list/api/single_list_static_t.h"
#define SINGLE_LISTt_H             "trash/list/api/single_list_t.h"
...
#define BINARY_TREE_STATICt_H      "trash/tree/api/binary_tree_static_t.h" 
